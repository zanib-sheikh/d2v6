...
<div className=" border bg-white shadow-md absolute left-[650px] rounded-lg md:w-[320px] w-[160px] h-[600px] md:p-2 p-2 justify-center md:mt-0 overflow-auto">
 ...
 <h3 className="text-md text-black font-bold">Upcoming Events</h3>
  <div className="mt-2 space-y-2">
    {/* Event 1 */}
    <div className="bg-lime-200 rounded-md p-3 flex items-center justify-between w-[300px]">
  ...
  <div className="relative flex -space-x-3">
    ...
    {/* Event 2 */}
    <div className="bg-blue-200 rounded-md p-3 flex items-center justify-between w-[300px]">
  {/* Left Section - Icon and Event Details */}
  <div className="flex items-center gap-3">
    {/* Circular Icon */}
    <div className="w-6 h-6 bg-white flex items-center justify-center rounded-full">
  ...
  <div className="relative flex -space-x-3">
    ...
    {/* Event 3 */}
    <div className="bg-red-100 rounded-md p-3 flex items-center justify-between w-[300px]">
  {/* Left Section - Icon and Event Details */}
  <div className="flex items-center gap-3">
    {/* Circular Icon */}
    <div className="w-6 h-6 bg-white flex items-center justify-center rounded-full">
