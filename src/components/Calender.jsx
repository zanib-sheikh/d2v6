...
const CalendarPage = () => {
  ...
  return (
    <div className="lg:pl-48 md:pl-56 mt-12 bg-blue-50 min-h-screen flex flex-col items-center">
      {/* Header with Calendar title and Add button */}
      <div className="w-full max-w-4xl flex justify-between mt-8 items-center mb-11">
